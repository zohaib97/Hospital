...
//fetch dentist data
if(isset($_POST['gpractionaldata']))
{
$e =	$_SESSION['gpractional'];
$query = mysqli_query($con,"SELECT * FROM `tbl_ruser` WHERE `ur_role_id` = 2 and `ur_email` = '$e'");
if($query)
{
while($fetch = mysqli_fetch_array($query))
{
