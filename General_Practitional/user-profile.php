        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data == 'Error'){
                     ...
                     toastr.clear();
    NioApp.Toast("<h5>Practitional didnot Update</h5>", 'error',{position:'top-right'});
              ...
              toastr.clear();
    NioApp.Toast("<h5>Practitional Updated Successfully</h5>", 'success',{position:'top-right'});
	fetchpractitional();
					$('#profile-edit').modal('hide');
