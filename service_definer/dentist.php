                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
										 <h2 class="nk-block-title fw-normal">Dentist list</h2>
...
//		if(updfname != ''){
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
//					document.getElementById("first_name").style.borderColor = "red";
//		} else if(updsname != ''){
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
//					document.getElementById("sure_name").style.borderColor = "red";
//		} else if(updemail != ''){
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
...
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
//					document.getElementById("mcontact").style.borderColor = "red";
//		}else if(upddepart != ''){
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
//					document.getElementById("mdepart").style.borderColor = "red";
//		}else if(upddob != ''){
//			toastr.clear();
//               NioApp.Toast("<h5>Please Fill This Feild</h5>", 'error',{position:'top-right'});
