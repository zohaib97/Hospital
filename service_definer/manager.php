                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
										 <h2 class="nk-block-title fw-normal">Managers list</h2>
                    ...
                    <form class="form-validate is-alter" id="aupdate" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                ...
                                <input type="text" class="form-control" id="first_name" name="fname" required autocomplete="off">
                            </div>
                        </div>
						<div class="form-group col-md-6">
                            <label class="form-label" for="sure_name">Sure Name</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="sure_name" name="sname" required autocomplete="off">
                            </div>
                        </div>
						</div>
						<div class="row">
						 <div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                <input type="email" class="form-control" id="memail" required name="memail" autocomplete="off">
                            </div>
                        </div>
						...
						<div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                <input type="password" class="form-control" id="mpass" required name="mpassword" autocomplete="off">
                            </div>
                        </div>
						</div>
						<div class="row">
						<div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="mcontact" required name="mcontact" autocomplete="off">
                            </div>
                        </div>
                       <div class="form-group col-md-6">
                            <label class="form-label" for="password">Department</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="mdepart" required name="mdepart" autocomplete="off">
                            </div>
                        </div>
						</div>
						<div class="row">
						<div class="form-group col-md-6">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control date-picker" id="mdob" required name="mdob" autocomplete="off">
                            </div>
                        </div>
						</div>
						<br>
