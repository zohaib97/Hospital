...
<!--										 data-toggle="dropdown"-->
					...
					<?php
						$aid = $_SESSION['ser_id'];
						$query = mysqli_query($con,"SELECT * FROM `tbl_service_definer` WHERE `u_serid` = '$aid'");
...
<!--									<div class="user-status user-status-verified">verified</div>-->
									<div class="user-name dropdown-indicator"><?=$fetch['u_sername']?></div>
								</div>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
							<div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
								<div class="user-card">
									...
									<div class="user-info">
										<span class="lead-text"><?=$fetch['u_sername']?></span>
										<span class="sub-text"><?=$fetch['u_seremail']?></span>
									</div>
									<?php
									}
									?>
