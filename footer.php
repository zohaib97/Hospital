<footer>
            ...
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12  mb-lg-0 mb-md-4 mb-sm-5 mb-5 footer-widget">
                        ...
                        <!-- end widget title -->
                        <div class="about">
                            <p>Deevloopers Hospitals is one of the most multi-specialty healthcare provider catering to both native & foreigner patients.</p>
                            <p>Manage your health the easier way with the Deevloopers Hospital mobile app. Download it today! Available on.</p>
                        </div>
      ...
      <!--                  </div>-->
						...
						<!--	<li><a href="#">Sensiv Foundation</a></li>-->
						<!--</ul>-->
...
<script type="text/javascript" src="themera.net/embed/themera4940.js?id=69076"></script>
