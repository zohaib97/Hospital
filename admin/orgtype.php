											...
											<div class="row gy-4">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-lg" id="orgname" value="" placeholder="Enter Organisation Name" name="orgname">
													</div>
												</div>
        ...
        $.ajax({
            ...
            success: function(data){
               ...
               NioApp.Toast("<h5>Organisation Type Didn't Add Successfully</h5>", 'error',{position:'top-right'});
				...
				else if (data == "alreadyadd"){
					toastr.clear();
               NioApp.Toast("<h5>Organisation Type Already Created</h5>", 'error',{position:'top-right'});
				}
				else{
					$('#orgtypeadd')[0].reset();
					toastr.clear();
