...
$("#privacyadd").on('submit', function(e){
		...
		var pdesc = $('#cf-default-textarea').val();
    ...
    NioApp.Toast("<h5>Privacy didn't Insert</h5>", 'error',{position:'top-right'});
					...
					document.getElementById("title").style.borderColor = "#28a745";
					document.getElementById("cf-default-textarea").style.borderColor = "#28a745";
                }
		...
		toastr.clear();
			...
			document.getElementById("cf-default-textarea").style.borderColor = "red";
	}
    });
</script>