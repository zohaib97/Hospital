                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
										 <h2 class="nk-block-title fw-normal">Appointment Type list</h2>
                                       
                                    </div>
                                    <a href="apptype.php" class="btn btn-primary float-right mb-2">Create Organisation Type</a><br>
                                     <br><br>
                ...
                <div class="modal-body">
                    <form class="form-validate is-alter" id="typeupdate" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-lg btn-primary" id="apptypeupdate">Save Informations</button>
                        </div>
                    </form>
                </div>
...
<script>
	...
	function confirm(id)
	{
      ...
      if (result.value) {
        Swal.fire('Deleted!', 'Appointment Type has been deleted.', 'success');
		  deleteadmin(id);
      }
    });
	}
	...
	function deleteadmin(id){
		...
		$.ajax({
            ...
            success: function(data){
              ...
              toastr.clear();
    NioApp.Toast("<h5>Appointment Type Didn't Delete</h5>", 'error',{position:'top-right'});
                }
				else if(data == 'Success'){
				
          toastr.clear();
    NioApp.Toast("<h5>Appointment Type Deleted Successfully</h5>", 'error',{position:'top-right'});
					fetchadmindata();
                }
	...
	$("#typeupdate").on('submit', function(e){
		...
		formdata.append("apptypeupdate","btn");
        $.ajax({
            type: 'POST',
            url: 'phpcode.php',
            data: formdata,
            ...
            processData:false,
            beforeSend: function(){
                $('#apptypeupdate').attr("disabled","disabled");
            ...
            success: function(data){
               ...
               NioApp.Toast("<h5>Name Updated Successfully</h5>", 'success',{position:'top-right'});
                ...
                $("#apptypeupdate").removeAttr("disabled");
            }
