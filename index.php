...
<!-- Mirrored from tm.hashtheme.com/se/sensive-preview3/sensive/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Mar 2021 09:39:26 GMT -->
<?php
...
<?php
						...
						<div class="row">
							<div class="col-lg-8 col-md-8 col-sm-8 col-12">
								<div class="home-single-slide-dec">
									...
									<a href="javascript:void(0)" class="home-btn-1">OUR SERVICES</a>
									<a href="javascript:void(0)" class="home-btn-2">CONTACT US</a>
								</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 col-12 d-lg-block d-md-block d-sm-block d-none">
								<img class="home-single-slide--img img-fluid" src="assets/img/bg/single-doc1.png" alt="" />
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-lg-8 col-md-8 col-sm-8 col-12">
								<div class="home-single-slide-dec">
									...
									<a href="javascript:void(0)" class="home-btn-1">GET APPOINTMENT</a>
									<a href="javascript:void(0)" class="home-btn-2">LAB REPORTS</a>
								</div>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4 col-12 d-lg-block d-md-block d-sm-block d-none">
								<img class="img-fluid" src="assets/img/bg/single-doc2.png" alt="" />
							</div>
						</div>
					</div>
				</div>
            ...
            <div class="row">
				<div class="col-lg-7 text-center mx-auto">
                    <div class="section-title">
                        <h3>Welcome to <span>Sensiv</span></h3>
	...
	<!-- START ABOUT SLIDER -->
    <div id="about-slider" class="section-padding pt-0">
        <div class="container">
            <div class="row">
    ...
    <section id="portfolio" class="section-padding p-0">
        <div class="container-fluid">
            <div class="row">
				<div class="col-lg-7 text-center mx-auto">
                    <div class="section-title">
                        <h3>Sensiv <span>Gallery</span></h3>
                        <span class="line"></span>
                    </div>
				</div>
				<!-- end section title -->
						...
						<div class="single-gallery single-gallery-first">
							...
							<div class="single-gallery">
								<div class="single-gallery-inner">
									...
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing.</p>
									<a href="#" class="info"><i class="icofont icofont-link"></i></a>
									<a href="assets/img/gallery/5.jpg" class="venobox info" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont icofont-expand"></i></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="service-slider owl-carousel owl-theme">
					<div class="single-service-item">
						<div class="single-service">
							...
							<a class="serv-rmbtn" href="javascript:void(0)">Read More</a>
						</div>	
					</div>
					<!-- end single service -->
					<div class="single-service-item">
					...
					<div class="single-doctor single-doctor-warp">
						...
						<div class="single-doctor-mask">
							<div class="single-doctor-mask-inner">
								...
								<ul>
								   <li><a href="javascript:void(0)">Get Appointment</a></li>
								</ul>
							</div>
						</div>
					</div>
    ...
    <section id="calltoaction" class="section-padding overlay section-back-image" data-background="assets/img/bg/promo-bg.jpg">
        <div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
					<div class="single-blog-home">
						...
						<a href="javascript:void(0)"><h5>Digital Bariatric Surgery</h5></a>
						...
						<a href="javascript:void(0)" class="blog-home-rmbtn">Continue <i class="icofont icofont-long-arrow-right"></i></a>	
					</div>
				</div>
				<!-- end single blog -->
				<div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
					<div class="single-blog-home">
						...
						<a href="javascript:void(0)"><h5>Obesity: A Growing Epidemic</h5></a>
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis eges vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.</p>
						<a href="javascript:void(0)" class="blog-home-rmbtn">Continue <i class="icofont icofont-long-arrow-right"></i></a>	
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 col-sm-12 col-12">
					<div class="single-blog-home">
						...
						<a href="javascript:void(0)"><h5>After Surgery Bed Rest</h5></a>
						<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis eges vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante.</p>
						<a href="javascript:void(0)" class="blog-home-rmbtn">Continue <i class="icofont icofont-long-arrow-right"></i></a>	
					</div>
				</div>
			...
			<div class="row">
				<div class="client-slider owl-carousel owl-theme">
					<div class="single-client">
						<a href="javascript:void(0)"><img class="img-fluid" src="assets/img/clients/1.png" alt=""></a>
					</div>
					<!-- end single client -->
					<div class="single-client">
						<a href="javascript:void(0)"><img class="img-fluid" src="assets/img/clients/2.png" alt=""></a>
					</div>
					<!-- end single client -->
					<div class="single-client">
						<a href="javascript:void(0)"><img class="img-fluid" src="assets/img/clients/3.png" alt=""></a>
					</div>
					<!-- end single client -->
					<div class="single-client">
						<a href="javascript:void(0)"><img class="img-fluid" src="assets/img/clients/4.png" alt=""></a>
					</div>
					<!-- end single client -->
					<div class="single-client">
						<a href="javascript:void(0)"><img class="img-fluid" src="assets/img/clients/1.png" alt=""></a>
