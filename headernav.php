								...
								<ul class="navbar-nav">
									<li class="active dropdown quick-search"><a href="#" class="nav-link">I want To</a>
										<ul class="dropdown-menu">
											<li><a href="register.php"><i class="icofont icofont-doctor-alt"></i>Register My Self</a></li>
											<li><a href="reg_organization.php"><i class="icofont icofont-doctor-alt"></i>Register Organisation</a></li>
										</ul>
									</li>
								</ul>
							</nav>	
