...
function aprovenotaprove(id, status, email) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data == 'Error') {
                toastr.clear();
                NioApp.Toast("<h5>Admin didn't Updated</h5>", 'error', {
                    position: 'top-right'
                });
                ...
                if (name == 'aapprove') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>Admin Approval Rejected</h5>", 'error', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                } else {
                    toastr.clear();
                    NioApp.Toast("<h5>Admin Approved Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data == 'Error') {
                ...
                toastr.clear();
                NioApp.Toast("<h5>Admin Didn't Delete</h5>", 'error', {
                    position: 'top-right'
                });
            } else if (data == 'Success') {

                toastr.clear();
                NioApp.Toast("<h5>Admin Delete Successfully</h5>", 'error', {
                    position: 'top-right'
                });
                fetchadmindata();
            }
