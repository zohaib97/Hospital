                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
										 <h2 class="nk-block-title fw-normal">Nurses list</h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Nurse Info</h5>
				...
				if(name == 'dactive') 
					{
						 ...
						 toastr.clear();
    NioApp.Toast("<h5>Nurse De-Activated</h5>", 'error',{position:'top-right'});
				fetchadmindata();
					}
					else{
              toastr.clear();
    NioApp.Toast("<h5>Nurse Activated Successfully</h5>", 'success',{position:'top-right'});
				fetchadmindata();
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Error') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>Nurse Didn't Delete</h5>", 'error', {
                        position: 'top-right'
                    });
                } else if (data == 'Success') {

                    toastr.clear();
                    NioApp.Toast("<h5>Nurse Active Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                }
                if (data == 'Errorr') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>Nurse  Not Active Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                }
