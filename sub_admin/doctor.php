                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
										 <h2 class="nk-block-title fw-normal">Dostors list</h2>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-light">
                    <span class="sub-text">Nurse Update</span>
                </div>
            </div>
        </div>
    </div>
	...
	var name  = status;
		...
		$.ajax({
            ...
            success: function(data){
                ...
                if(data == 'Error'){
                   toastr.clear();
    NioApp.Toast("<h5>Doctor didn't Updated</h5>", 'error',{position:'top-right'});
				...
				if(name == 'dactive') 
					{
						 ...
						 toastr.clear();
    NioApp.Toast("<h5>Doctor De-Activated</h5>", 'error',{position:'top-right'});
				fetchadmindata();
					}
					else{
              toastr.clear();
    NioApp.Toast("<h5>Doctor Activated Successfully</h5>", 'success',{position:'top-right'});
				fetchadmindata();
