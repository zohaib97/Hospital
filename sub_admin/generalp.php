                            ...
                            <div class="nk-content-body">
                                <div class="components-preview wide-md mx-auto">
                                    <div class="nk-block-head nk-block-head-lg wide-sm">
                                        <h2 class="nk-block-title fw-normal">General practitioner list</h2>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Error') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>General pratictional Delete Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                }
    ...
    $("#aupdate").on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Error') {
                    toastr.clear();
                    NioApp.Toast("<h5>Nurse didn't update Successfully</h5>", 'error', {
                        position: 'top-right'
                    });
                } else if (data == 'Success') {
                    $('#aupdate')[0].reset();
                    toastr.clear();
                    NioApp.Toast("<h5>Nurse Updated Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
