                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Online Admins</h3>
                                ...
                                <div class="nk-block">
                                    <div class="row g-gs">
										<?php
										$query = mysqli_query($con,"SELECT * FROM `admin` WHERE `super_admin` = '0' and `on/off` = 'on'");
...
-->
			...
			{
			?>
				<script>Swal.fire('No Users!', 'No Users Online.', 'warning');</script>
			<?php
			}
			?>
            <!-- wrap @e -->
