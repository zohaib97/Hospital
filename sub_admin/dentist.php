	...
	function deleteadmin(id){
		...
		$.ajax({
            ...
            success: function(data){
              ...
              toastr.clear();
    NioApp.Toast("<h5>Dentist Didn't Delete</h5>", 'error',{position:'top-right'});
                }
				else if(data == 'Success'){
				
          toastr.clear();
    NioApp.Toast("<h5>Dentist Delete Successfully</h5>", 'success',{position:'top-right'});
					fetchadmindata();
                }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == 'Error') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>Dentist Didn't Delete</h5>", 'error', {
                        position: 'top-right'
                    });
                } else if (data == 'Success') {

                    toastr.clear();
                    NioApp.Toast("<h5>Dentist Active Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                }
                if (data == 'Errorr') {
                    ...
                    toastr.clear();
                    NioApp.Toast("<h5>Dentist  Not Active Successfully</h5>", 'success', {
                        position: 'top-right'
                    });
                    fetchadmindata();
                }
