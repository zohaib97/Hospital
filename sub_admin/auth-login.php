...
<?php
	if(isset($_POST['signin']))
	{
		$email = $_POST['email'];
		$pass = $_POST['pass'];
		$query = mysqli_query($con,"SELECT * FROM `admin` WHERE email = '$email' and password = '$pass' and super_admin = '0'");
		if($query)
		{
                            ...
                            <div class="card-inner card-inner-lg">
                                ...
                                <form method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control form-control-lg" id="default-01" placeholder="Enter your email address or username" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg" id="password" name="pass" placeholder="Enter your passcode" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="form-group">
