                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                ...
                                <a href="createpatient.php" type="button" class="btn btn-primary float-right " >Create New Patient</a>
                                   ...
                                   <div class=" mr-3">
                                   <a href="javascript:void(0);" type="button" class="btn btn-primary float-right " id="nhs" style="font-size: 12px;">Demographics</a>

                                   </div>


                                   <div class="form-group" >
                                   <input style="border-color: #000000 ;width: 87%;" class="form-control" placeholder="search NHS NO" type="number" max="3" length id="nh3" value="NH-"
                                   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                   ...
                                   <div class="col-md-1" id="btn">
                                     ...
                                     <div class="row" id="nhsno" style="display: none;">
										<div class="col-md-2">
											...
											<div class="col-md-2">
                                                <label for="">Name</label>
											<input style="border-color: #000000" class="form-control" type="text" max="3" length id="nm" value=""
												   required >
									</div>
											<div class="col-md-2">
                                            <label for="">Surname</label>
											<input style="border-color: #000000" class="form-control" type="text" id="em"
									...
									<div class="col-md-3">
                                    <label for="">Date of birth</label>
											<input style="border-color: #000000 ;" class="form-control date-picker" type="text" max="3" id="dob"
												   required onChange="showsearch()">
											</div>
											<div class="col-md-2" id="btn2">
	...
	function deleteadmin(id){
		...
		$.ajax({
            ...
            success: function(data){
              ...
              toastr.clear();
    NioApp.Toast("<h5>Manager Didn't Delete</h5>", 'error',{position:'top-right'});
                }
				else if(data == 'Success'){
				
          toastr.clear();
    NioApp.Toast("<h5>Manager Delete Successfully</h5>", 'success',{position:'top-right'});
					fetchadmindata();
                }
	...
	var name  = status;
		...
		$.ajax({
            ...
            success: function(data){
                ...
                if(data == 'Error'){
                   toastr.clear();
    NioApp.Toast("<h5>Manager didn't Updated</h5>", 'error',{position:'top-right'});
				...
				if(name == 'mactive') 
					{
						 ...
						 toastr.clear();
    NioApp.Toast("<h5>Manager De-Activated</h5>", 'error',{position:'top-right'});
				fetchadmindata();
					}
					else{
              toastr.clear();
...
//				alert(data);
                if(data == 'Error'){
                   toastr.clear();
               NioApp.Toast("<h5>Manager didn't update Successfully</h5>", 'error',{position:'top-right'});
                }
				else if(data == 'Success'){
					$('#aupdate')[0].reset();
					toastr.clear();
               NioApp.Toast("<h5>Manager Updated Successfully</h5>", 'success',{position:'top-right'});
					fetchadmindata();
...
function ssearch(ddd){	
		...
		var btn = document.getElementById('btn').innerHTML='<a href="javascript:void(0)" class="btn btn-info float-right" id="patient" onClick="spatient('+ddd+')">Search</a>';
			document.getElementById('btn2').innerHTML='<a href="javascript:void(0)" class="btn btn-primary" id="patient" onClick="res()">Reset</a>';
...
function showsearch() {	
		...
		var btn = document.getElementById('btn').innerHTML='<a href="javascript:void(0)" class="btn btn-info float-right" id="searchpatient" onClick="showpatient(\'' + dob + '\')">Search</a>';
  ...
  var dob = $('#dob').val();
      ...
      $.ajax({    
        type: "POST",
        url: "phpcode.php", 
		data:{dob:dob,em:em,nm:nm,searchpatient:"btn"},	            
        success: function(response){ 
